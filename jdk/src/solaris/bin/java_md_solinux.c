...
jboolean LoadJavaVM(const char *jvmpath, InvocationFunctions *ifn)
{
    ...
    printf("【log】jdk/src/solaris/bin/java_md_solinux.c LoadJavaVM() 加载libjvm动态链接库 jvmpath=%s\n",jvmpath);
    ...
    printf("【log】jdk/src/solaris/bin/java_md_solinux.c LoadJavaVM() 获取libjvm库函数 JNI_CreateJavaVM\n");
    ...
    printf("【log】jdk/src/solaris/bin/java_md_solinux.c LoadJavaVM() 获取libjvm库函数 JNI_GetDefaultJavaVMInitArgs\n");
    ...
    printf("【log】jdk/src/solaris/bin/java_md_solinux.c LoadJavaVM() 获取libjvm库函数 JNI_GetCreatedJavaVMs\n");
...
ContinueInNewThread0(int (JNICALL *continuation)(void *), jlong stack_size, void * args) {
    ...
    printf("【log】jdk/src/solaris/bin/java_md_solinux.c ContinueInNewThread0() 调用pthread_create创建新线程,启动JavaMain入口\n");
        ...
        int mode, char *what, int ret)
{
    ...
    printf("【log】jdk/src/solaris/bin/java_md_solinux.c JVMInit() 调用ContinueInNewThread创建一个新线程来执行JavaMain\n");
