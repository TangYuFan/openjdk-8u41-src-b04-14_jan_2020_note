...
)
{
    ...
    printf("【log】jdk/src/share/bin/java.c JLI_Launch() pname=%s,lname=%s,fullversion=%s,dotversion=%s\n",pname,lname,fullversion,dotversion);
...
int JNICALL JavaMain(void * _args){
    ...
    printf("【log】jdk/src/share/bin/java.c JavaMain() 真正的jvm初始化入口\n");
    ...
    /* Invoke main method. */
    printf("【log】jdk/src/share/bin/java.c 调用main方法,封装成jni\n");
...
static jboolean InitializeJVM(JavaVM **pvm, JNIEnv **penv, InvocationFunctions *ifn) {
    ...
    printf("【log】jdk/src/share/bin/java.c InitializeJVM() 初始化jvm,调用CreateJavaVM进行初始化,调用libjvm中的库函数NI_CreateJavaVM\n");
...
LoadMainClass(JNIEnv *env, int mode, char *name)
{
    ...
    printf("【log】jdk/src/share/bin/java.c LoadMainClass() 加载一个类并验证主类是否存在\n");
                    ...
                    int mode, char *what, int ret)
{
    ...
    printf("【log】jdk/src/share/bin/java.c ContinueInNewThread() 继续调用ContinueInNewThread0入口\n");
