...
{
    printf("【log】jdk/src/share/native/java/lang/ClassLoader.c Java_java_lang_ClassLoader_registerNatives()\n");
...
//    printf("【log】jdk/src/share/native/java/lang Java_java_lang_ClassLoader_findBootstrapClass() 本地实现类加载入口:classname=%s\n",classname);
