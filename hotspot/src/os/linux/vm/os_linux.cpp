...
//    printf("【log】hotspot/src/os/linux/vm/os_linux.cpp java_start() 线程启动\n");
...
//      printf("【log】hotspot/src/os/linux/vm/os_linux.cpp os::create_thread() stack_size=%d\n",stack_size);
...
//    printf("【log】hotspot/src/os/linux/vm/os_linux.cpp os::pd_start_thread() 启动linux线程\n");
