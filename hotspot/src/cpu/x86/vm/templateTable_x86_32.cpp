    ...
    if (UseLoopCounter) {
        ...
        if (TieredCompilation) {
            ...
            if (ProfileInterpreter) {
                ...
                __ increment_mask_and_jump(mdo_backedge_counter, increment, mask,rax, false, Assembler::zero, &backedge_counter_overflow);
                __ jmp(dispatch);
            }
            __ bind(no_mdo);
            ...
            if (ProfileInterpreter) {
                ...
                __ cmp32(rax,ExternalAddress((address) &InvocationCounter::InterpreterProfileLimit));
                ...
                if (UseOnStackReplacement) {
                    ...
                    //如果小于则跳转到dispatch
                    __ cmp32(rbx,ExternalAddress((address) &InvocationCounter::InterpreterBackwardBranchLimit));
                ...
                if (UseOnStackReplacement) {
                    ...
                    __ cmp32(rax,ExternalAddress((address) &InvocationCounter::InterpreterBackwardBranchLimit));
