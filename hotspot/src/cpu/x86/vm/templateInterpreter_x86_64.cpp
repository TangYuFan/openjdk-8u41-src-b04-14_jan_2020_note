...
//    printf("【log】hotspot/src/cpu/x86/vm/templateInterpreter_x86_64.cpp InterpreterGenerator::generate_counter_incr() 调用计数\n");
...
//    printf("【log】hotspot/src/cpu/x86/vm templateINterpreter_x86_64.cpp InterpreterGenerator::generate_counter_overflow() \n");
...
//    printf("【log】hotspot/src/cpu/x86/vm/templateInterpreter_x86_64.cpp InterpreterGenerator::generate_fixed_frame() 创建entry(局部变量表/调用者栈顶/Java方法指针)\n");
...
//    printf("【log】hotspot/src/cpu/x86/vm/templateInterpreter_x86_64.cpp InterpreterGenerator::generate_native_entry() 生成native方法的stub\n");
...
//    printf("【log】hotspot/src/cpu/x86/vm/templateInterpreter_x86_64.cpp InterpreterGenerator::generate_normal_entry() 创建entry(局部变量表/调用者栈顶/Java方法指针)\n");
...
//    printf("【log】hotspot/src/cpu/x86/vm/templateInterpreter_x86_64.cpp TemplateInterpreterGenerator::set_vtos_entry_points() 将字节码指令生成汇编代码\n");
