...
//    printf("【log】hotspot/src/share/vm/oops/method.cpp Method::set_native_function()\n");
...
//    printf("【log】hotspot/src/share/vm/oops/method.cpp Method::link_method() 调用entry_for_method()获取已经创建好的entry,然后调用set_interpreter_entry()保存到目标属性上 \n");
