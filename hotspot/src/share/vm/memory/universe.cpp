...
jint universe_init() {
    ...
    printf("【log】hotspot/src/share/vm/memory.universe.cpp universe_init() 堆空间,元空间,AOTLoader,SymbolTable,StringTable,G1收集器初始化\n");
...
void universe2_init() {
    ...
    printf("【log】hotspot/src/share/vm/memory/universe.cpp universe2_init() vmSymbols，系统字典，预加载类，构建基本数据对象模型\n");
