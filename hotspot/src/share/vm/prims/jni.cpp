...
//    printf("【log】hotspot/src/share/vm/prims/jni.cpp jni_invoke_static() 通过jni解释调用java静态方法\n");
...
//    printf("【log】hotspot/src/share/vm/prims/jni.cpp jni.cpp jni_RegisterNatives() meth_name=%s\n",meth_name);
...
_JNI_IMPORT_OR_EXPORT_ jint JNICALL JNI_CreateJavaVM(JavaVM **vm, void **penv, void *args) {
    ...
    printf("【log】hotspot/src/share/vm/prims/jni.cpp JNI_CreateJavaVM() 进入jvm初始化阶段,Threads::create_vm()执行入口\n");
