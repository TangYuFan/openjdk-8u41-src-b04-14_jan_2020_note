...
//    printf("【log】hotspot/src/share/vm/runtime/thread.cpp JavaThread::JavaThread() 对象初始化,传入 java_thread() 作为运行函数 \n");
...
jint Threads::create_vm(JavaVMInitArgs* args, bool* canTryAgain) {
    ...
    printf("【log】hotspot/src/share/vm/runtime.c Threads::create_vm() jvm初始化入口\n");
...
//    printf("【log】hotspot/src/share/vm/runtime.c is_supported_jni_version() 检测JNI版本\n");
