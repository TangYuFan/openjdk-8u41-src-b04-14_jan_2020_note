...
//  printf("【log】hotspot/src/share/vm/classfile/classLoader.cpp ClassLoader::load_classfile() 使用引导类加载器进行类加载:%s\n",class_name);
...
void classLoader_init() {
    ...
    printf("【log】hotspot/src/share/vm/classfile/classLoader.cpp classLoader_init() 类加载器初始化第一阶段：zip,jimage入口，设置启动类路径\n");
...
void ClassPathDirEntry::compile_the_world(Handle loader, TRAPS) {
    ...
    printf("【log】hotspot/src/share/vm/classfile.calssLoader.cpp compile_the_world() \n");
