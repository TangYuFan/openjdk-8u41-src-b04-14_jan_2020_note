...
void CppInterpreter::initialize() {
    ...
    printf("【log】hotspot/src/share/vm/interpreter cppInterpreter.cpp CppInterpreter::initialize()\n");
...
void CppInterpreterGenerator::generate_all() {
    ...
    printf("【log】hotspot/src/share/vm/interpreter/cppInterpreter.cpp CppInterpreterGenerator::generate_all()\n");
