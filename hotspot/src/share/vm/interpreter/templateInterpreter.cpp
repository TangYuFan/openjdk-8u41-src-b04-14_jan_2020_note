...
void TemplateInterpreter::initialize() {
    ...
    printf("【log】hotspot/src/share/vm/interpreter/templateInterpreter.cpp TemplateInterpreter::initialize()\n");
...
//  printf("【log】hotspot/src/share/vm/interpreter/templateInterpreter.cpp DispatchTable::set_entry() 当前Opcode=%d\n",i);
...
void TemplateInterpreterGenerator::generate_all() {
    ...
    printf("【log】hotspot/src/share/vm/interpreter/templateInterpreter TemplateInterpreterGenerator::generate_all() 生成每中Java方法类型的entry_point\n");
...
//    printf("【log】hotspot/src/share/vm/interpreter/templateInterpreter.cpp TemplateInterpreterGenerator::set_entry_points_for_all_bytes() size=%d\n",DispatchTable::length);
...
//    printf("【log】hotspot/src/share/vm/interpreter/templateInterpreter.cpp TemplateInterpreterGenerator::set_entry_points()\n");
...
//    printf("【log】hotspot/src/share/vm/interpreter/templateInterpreter.cpp TemplateInterpreterGenerator::generate_and_dispatch()\n");
