...
void compileBroker_init() {
    ...
    printf("【log】hotspot/src/share/vm/complier/complierBroker.cpp compileBroker_init() 编译器初始化\n");
...
//    printf("【log】hotspot/src/share/vm/compiler/compileBroker.cpp CompileBroker::compile_method() 提交编译任务 osr_bci=%d,comp_level=%d\n",osr_bci,comp_level);
...
//    printf("【log】hotspot/src/share/vm/compiler/compileBroker.cpp CompileBroker::invoke_compiler_on_method() 编译任务执行,当前编译器:%s\n",comp->name());
